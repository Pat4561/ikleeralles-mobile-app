...
abstract class TableViewProviderProtocol<T>  {
...
class TableViewBuilder {
  ...
  static dynamic _funcResult(Function toCheck, Function toFire) {
    if (toCheck != null) {
      return toFire();
    }
    return null;
  ...
  void buildSections() {
    ...
    for (int sectionIndex = 0; sectionIndex < sectionCount; sectionIndex++) {
      Section section = Section(
          ...
          hasHeader: _funcResult(sectionHeaderBuilder, () => sectionHeaderBuilder(sectionIndex)) != null,
          hasFooter: _funcResult(sectionFooterBuilder, () => sectionFooterBuilder(sectionIndex)) != null,
...
class TableView extends StatelessWidget {
  ...
  TableView(this.builder, { this.padding });
